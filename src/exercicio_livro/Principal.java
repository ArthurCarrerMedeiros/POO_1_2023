...
public class Principal {
    public static void main(String[] args) {
        ...
        while(Integer.parseInt(JOptionPane.showInputDialog("Deseja cadastrar um novo livro?\n1 - Sim\n2 - Não")) == 1) {
        ...
        if (Integer.parseInt(JOptionPane.showInputDialog("Deseja procurar os livros de algum autor?\n1 - Sim\n2 - Não")) == 1) {
        ...
        if (Integer.parseInt(JOptionPane.showInputDialog("Deseja procurar os livros pelo sexo do autor?\n1 - Sim\n2 - Não")) == 1) {
            char sexo = JOptionPane.showInputDialog("Digite o sexo do autor que deseja pesquisar (M/F): ").toUpperCase().charAt(0);
        ...
        if (Integer.parseInt(JOptionPane.showInputDialog("Deseja procurar os livros por uma faixa de valor?\n1 - Sim\n2 - Não")) == 1) {
        ...
        if (Integer.parseInt(JOptionPane.showInputDialog("Deseja procurar os livros em que o autor tenha até no máximo uma certa idade?\n1 - Sim\n2 - Não")) == 1) {
