...
public class Livro {
    ...
    public void cadastrarLivro() {
        ...
        int resp = Integer.parseInt(JOptionPane.showInputDialog("Deseja cadastrar um autor para o livro?\n1 - Sim\n2 - Não"));
        ...
        while (resp == 1 || autores.isEmpty()) {
            ...
            resp = Integer.parseInt(JOptionPane.showInputDialog("Deseja cadastrar um autor para o livro?\n1 - Sim\n2 - Não"));
        }
    }

    public boolean validarLivro(Livro livro) {
        if (livro.getTitulo() == null || livro.getTitulo().equals("") || livro.getPreco() <= 0) {
            JOptionPane.showMessageDialog(null, "Os dados informados para o livro são inválidos, tente cadastrar novamente!");
            return false;
        }
